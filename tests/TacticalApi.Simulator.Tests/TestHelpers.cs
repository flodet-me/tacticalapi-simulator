...
internal static class TestHelpers
{
    ...
    /// <summary>A fixed <see cref="IOptionsMonitor{T}" /> for any options type - no reload support, just a constant CurrentValue.</summary>
        ...
        SituationObject.TypeOneofCase typeCase, string id, DateTimeOffset reportingTime, DateTimeOffset expiry)
    {
        ...
        return typeCase switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(typeCase), typeCase, "No expirable update builder for this type.")
        };
    }
